...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///neoshare.db'
...
def index():
    ...
    return render_template('index.html', public_files=public_files)
...
def dashboard():
    ...
    # 获取公共文件
    public_files = File.query.filter_by(is_public=True).all()
    return render_template('dashboard.html', user_files=user_files, public_files=public_files)
